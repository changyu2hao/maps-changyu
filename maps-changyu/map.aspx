        ...
        <asp:Panel id="popup" runat="server" CssClass="popup">
            <table>
                <tr>
                    ...
                    <td>
                    <input id="lblcountPlayers" type="hidden" runat="server" />
                    <input id="lblcountDate" type="hidden" runat="server" />
                    <input id="lblcountTime" type="hidden" runat="server" />
                    <input id="lblcountPhone" type="hidden" runat="server" />
                    <input id="lblcountType" type="hidden" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td>
